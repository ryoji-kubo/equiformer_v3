...
CONFIG_PATH="experimental/configs/omat24/mptrj/experiments/direct/transformer_NoDeNS_EnergyOnly.yml"
IDENTIFIER="transformer_mptrj_direct_NoDeNS_EnergyOnly"
