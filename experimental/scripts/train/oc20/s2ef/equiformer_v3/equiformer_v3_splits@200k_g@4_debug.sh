...
CONFIG_PATH="experimental/configs/oc20/200k/equiformer_v3/experiments/base_N@8-L@6-C@128-attn-hidden@64-ffn@512-envelope-num-rbf@128_merge-layer-norm_gates2-gridmlp_use-gate-force-head_wd@1e-3-grad-clip@100_lin-ref-e@4_debug.yml"
IDENTIFIER="base"
