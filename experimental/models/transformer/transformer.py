...
class StructureTransformer(nn.Module):
    ...
    an encoded position. The cell is encoded as a per-structure token and as a
    per-layer sequence condition.
    """
    ...
    def _dense_inputs(
        ...
        atom_index_order = None
        inverse_atom_index_order = None
